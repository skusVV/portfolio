export const projects = [
    ...
    {
      title: "Awesome Health Club",
      description: "Developing health and welness website.",
      customer: "US Company",
      involvement: "12 months",
      role: "Key Developer",
      responsibilities: "Development, architecture, and optimization.",
      teamSize: "4-6",
